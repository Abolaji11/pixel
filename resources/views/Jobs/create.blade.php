<x-layout>
    ...
    <x-forms.form method="post" action="/jobs" id="jobForm">
        ...
        <x-forms.checkbox label="feature (Costs Extra)" name="featured" id="featuredCheckbox" />

        <hr />

        <x-forms.input label="Tags (comma seperated)" name="tags" placeholder="laracasts, video, education" />

        <x-forms.button style="margin-bottom: 10px" id="publishButton">Publish</x-forms.button>
    </x-forms.form>
